<template>
  <div class="accountOrder">
    ...
    <div class="orderContent" v-if="this.orderArr.length">
      <!--<div class="scroll-content">-->
      <div class="line1" v-for="(l,index) in orderArr" v-bind:key="index">
        <div class="order-img" style="">
          {{l.item}}
        </div>
        <div class="orderInfo">
          <div class="orderType">
            <span v-if="l.orderType === 'CB'">呼唤铃</span>
            <span v-if="l.orderType === 'FO'">机上餐食</span>
            <span v-if="l.orderType === 'GR'">机上升舱</span>
            <span v-else>空中商城</span>
          </div>
    ...
    <div class="orderContent" v-else style="text-align:center;padding:50px 0;background-color:white !important;"> 您的订单空空如也，赶快去首页下单吧 </div>
