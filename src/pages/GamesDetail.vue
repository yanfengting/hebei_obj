    ...
    <div
      ...
      <div style="margin:10px;display:flex;flex-direction:row;width:55%;">
        <div class="game-content contentdetail" >
          <div class="quiz-height detail-height" style = "background-size: contain;"
               :style="{'background': 'url('+data.poster+') center center / 100% 100% no-repeat','background-size':'100% 100%'}"></div>
        </div>
        <div class="game-desc">
